...
def lecture_bot_check(
    ...
    fail-closed: 검증 실패·설정 누락은 통과가 아니다. 통과를 확인하지 못했으면 통과가 아니다.
    """
    auth_service.rate_limit(
